...
export default function App() {
  ...
  const handleInjectEvent = (type: string, name: string, description: string, severity: number, duration: number) => {
    setState(prev => injectEvent(prev, type as SimEvent['type'], name, description, severity, duration));
  };
          ...
          <div className="h-full grid grid-cols-12 gap-3">
            ...
            <div className="col-span-5 min-h-0">
              <ScenarioPanel
                ...
                activeEventTypes={state.activeEvents.filter(e => e.active).map(e => e.type)}
